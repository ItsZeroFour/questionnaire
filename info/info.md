...
*на счет 6 пункта. Я вам с сервера на ноде или с клиента буду отправлять по api айдишник опроса пользователя, вы в свою очередь его получаете и записываете в массив опросников пользователя*.
...
_iduser123456789 - id пользователя. Оно автоматически записывается в обхект пользователя в MongoDB. и имеет значение "_id". Пример:_
