...
Вам так же надо добавить git на этот VPS. Что бы сколировать репозиторий на ваш VPS. <a href="https://chatgpt.com/share/673f1e4d-9590-8010-ab18-cb94277c621f">Подробнее</a>

Пересичлю базовые команды для взаимодействия с Linus Ubuntu:
